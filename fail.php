...
<section id="Bride_Groom">
    ...
    <center> <h4><b>Silahkan Ceklis Keterangan Kenapa UUID QR Code Tersebut Di Anggap Fail Atau Bermasalah</b></h4>
           </center>
        ...
        <?php
                        ...
                        $no=1;
                           $sql ="SELECT * FROM table_attendance ORDER BY id DESC LIMIT 1";
                           $query = $conn->query($sql);
                           while ($row = $query->fetch_assoc()){
                        ?>
            <tr>
                <td width="20px" valign="top"><h4><b>UUID :</b></td></h4>
                <td valign="top">
        ...
        ?>
            <tr>
                <td width="20px" valign="top"><h4><b>Keterangan :<br> <h6><b>Bisa Ceklis Lebih Dari Satu</b></h6></b></td></h4>
                <td valign="top">
                <label><input type="checkbox" name="keterangan[]" value="Gelembung"> Gelembung</label><br>
                <label><input type="checkbox" name="keterangan[]" value="Kotor"> Kotor</label><br>
                <label><input type="checkbox" name="keterangan[]" value="Beleber"> Beleber</label><br>
                <label><input type="checkbox" name="keterangan[]" value="Miring"> Emasnya Miring</label><br>
                <label><input type="checkbox" name="keterangan[]" value="Pecah"> Angin Pecah</label><br>
                <label><input type="checkbox" name="keterangan[]" value="Kopong"> Emas Kopong</label><br>
                <label><input type="checkbox" name="keterangan[]" value="Goyang"> Emas Goyang</label><br>
                <label><input type="checkbox" name="keterangan[]" value="Gambar"> Gambar Pudar</label><br>
