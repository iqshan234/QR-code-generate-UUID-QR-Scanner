      ...
      <a href="index.php" title="Home" rel="home" class="site-branding__logo">
       ...
       <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                <form action="database31.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
			...
			<div class="col-md-15">
				...
				<p>Data Scan QR Code UUID Produksi</p>
