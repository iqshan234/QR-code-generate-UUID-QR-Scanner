      ...
      <a href="index.php" title="Home" rel="home" class="site-branding__logo">
       ...
       <div class="container">
            <div class="row">
              ...
              <a href=\"fail.php\"> <button type='button' class='button button1' data-dismiss='alert' aria-hidden='true'>&times;</button>
              ...
              <a href=\"fail.php\"> <button type='button' class='button button1' data-dismiss='alert' aria-hidden='true'>&times;</button>
                ...
                <div class="col-md-8">
                <form action="database21.php" method="post" class="form-horizontal" style="border-radius: 5px;padding:10px;background:#fff;" id="divvideo">
                     <i class="glyphicon glyphicon-qrcode"></i> <label>SCAN QR CODE UUID Mini Gold</label> <p id="time"></p>
               ...
               <p>Data Scan QR Code UUID Mini Gold </p>
