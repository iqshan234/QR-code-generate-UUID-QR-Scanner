    ...
    <div class="container">
        <div class="row">
            ...
            <img src="logo-minigold-small.png"> 
                <center> 
                    <a href="scanner_pro1.php"><button class="button button2" style="resize:none;width:500px;height:100px;">Scanner QR Code & Menampilkan Data Baru</button></a><br>
                    <a href="scanner_pro2.php"><button class="button button1" style="resize:none;width:500px;height:100px;">Scanner QR Code & Menampilkan Semua Data</button></a>
                </center>
                <br><br>
</div>
</div>
